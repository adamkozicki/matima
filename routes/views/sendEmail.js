...
exports.sendEmail = function (mailOptions) {
    ...
    var fromPerson = mailOptions.from || '',
        ...
        transporter = nodemailer.createTransport('smtps://studiomatima@gmail.com:martusia144@smtp.gmail.com'),
    ...
    // 1. Wysyłanie maila z formularza kontaktowego
            var optionsMail = {
                ...
                html: '<h2>Otrzymałeś wiadomość od '+ from + ' -- ' + fromEmail + ' o treści: </h2><hr><br><h3>' + messageContent + '</h3><br><br><hr>'// html body
            };
        break;
